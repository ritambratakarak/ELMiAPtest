...
const EncryptDownload = () => {
  ...
  return (
    ...
    >
      ...
      <Text style={{ alignSelf: "flex-start", left: 10 }}>
        File Encryption
      </Text>
      <Pressable
        style={{ width: "90%", height: 50, top: 36 }}
      ...
      <TextInput
        style={{ height: 50, borderWidth: 2, top: 38, width: "90%" }}
        placeholder="  Encrypted File Path"
        value={encryptFilePath}
      />
      <TextInput
        style={{ height: 50, borderWidth: 2, top: 40, width: "90%" }}
        placeholder="  Password"
      ...
      <Text style={{ top: 48, alignSelf: "flex-start", left: 10 }}>
        File Decryption
      </Text>
      <TextInput
        style={{ height: 50, borderWidth: 2, top: 50, width: "90%" }}
        placeholder="  Encrypted File Path"
      ...
      />
      <TextInput
        style={{ height: 50, borderWidth: 2, top: 56, width: "90%" }}
        placeholder="  IV"
        onChangeText={(iv) => setFileIv(iv)}
        value={fileIv}
      />
      <TextInput
        style={{ height: 50, borderWidth: 2, top: 58, width: "90%" }}
        placeholder="  Salt"
        onChangeText={(salt) => setFileSalt(salt)}
        value={fileSalt}
      />
      <TextInput
        style={{ height: 50, borderWidth: 2, top: 60, width: "90%" }}
...
export default EncryptDownload;